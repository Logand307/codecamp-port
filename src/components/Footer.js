...
export default function Footer() {
  return (
    <footer class=" flex items-center w-full	sticky bottom-0 right-0 p-4 bg-white shadow md:flex-column md:items-center md:p-1 dark:bg-gray-800 justify-center  ">
